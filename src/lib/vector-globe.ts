...
/** Shared vector land data — the 2D map projects the exact same outlines. */
export const LAND_POLYGONS: readonly Ring[][] = POLYGONS;
export const LAND_RINGS: readonly Ring[] = RINGS;
